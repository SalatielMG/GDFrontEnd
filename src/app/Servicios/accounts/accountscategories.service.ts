...
export class AccountscategoriesService {
  ...
  public obtAccountsBackup(id_backup, categoriesSearch = "1"): Observable<any> {
    return this.http.get(URL + "obtAccountsBackup", {params: {id_backup: id_backup, categoriesSearch: categoriesSearch}});
  }
}
